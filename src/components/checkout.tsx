        ...
        <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-xl">
                    <h2 className="text-2xl font-bold text-gray-900 mb-6">Детали за наплата</h2>

                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div className="space-y-5">
                            {/* Personal Info Section */}
                            <div className="space-y-4">
                                <h3 className="text-lg font-semibold text-gray-900">Лични информации</h3>
                            ...
                            <div className="space-y-4">
                                <h3 className="text-lg font-semibold text-gray-900">Адреса за достава</h3>
                                <div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-2">Општина</label>
                                        <input
                                            type="text"
                                            name="municipality"
                        ...
                        <div className="space-y-4 pt-6 border-t border-gray-200">
                            <h3 className="text-lg font-semibold text-gray-900">Начин на наплата</h3>
                ...
                <div className={`bg-white p-6 rounded-2xl shadow-xl h-fit`}>
                    <h2 className="text-2xl font-bold text-gray-900 mb-6">Вашата нарачка</h2>
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4 pt-6 border-t border-gray-200">
                            ...
                            <div className="flex justify-between pt-4 border-t border-gray-200">
                                <span className="text-lg font-bold text-gray-900">Вкупно</span>
                                <span className="text-lg font-bold text-gray-900">{total} ден.</span>
                            </div>
                        </div>
                    </div>
                </div>
